...
SPLUNK_CONFIG_NOTIFICATION_HEC_TOKEN = os.environ['SPLUNK_CONFIG_NOTIFICATION_HEC_TOKEN']
...
def handler(event, context):
    ...
    if event['RequestType'] == 'Create':
        try:
            response = client.create_delivery_stream(
                ...
                SplunkDestinationConfiguration={
                    ...
                    'HECEndpointType': 'Raw',
                    'HECToken': SPLUNK_CLOUDTRAIL_HEC_TOKEN,
        ...
        try:
            response = client.create_delivery_stream(
                ...
                SplunkDestinationConfiguration={
                    ...
                    'S3BackupMode': 'FailedEventsOnly',
                    'S3Configuration': {
                        'RoleARN': event["ResourceProperties"]["ConfigNotificationBackupS3Role"],
                        'BucketARN': event["ResourceProperties"]["ConfigNotificationBackupS3Bucket"],
                        'BufferingHints': {
                            'SizeInMBs': 5,
                            'IntervalInSeconds': 300
                        },
                        ...
                        # "CloudWatchLoggingOptions": {
                        #     "Enabled": True,
                        #     "LogGroupName": "/aws/kinesisfirehose/splunk-config-notification-cwe-monitoring",
                        #     "LogStreamName": "S3Delivery"
                        # }
                    },
                    'ProcessingConfiguration': {
        ...
        bucket = s3resource.Bucket(event["ResourceProperties"]["ConfigNotificationBackupS3BucketName"])
